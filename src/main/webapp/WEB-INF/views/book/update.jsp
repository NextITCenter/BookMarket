		...
		<div class="align-items-md-stretch">
			<form action="${pageContext.request.contextPath }/books/update" method="post" enctype="multipart/form-data">
				...
				<div class="row my-3">
					...
					<div class="col-md-5">
						<input type="radio" name="condition" value="New" class="btn-check" id="new" ${book.condition == 'New' ? 'checked' : ''}>
						<label for="new" class="btn btn-outline-primary">신규도서</label>
						<input type="radio" name="condition" value="Old" class="btn-check" id="old" ${book.condition == 'Old' ? 'checked' : ''}>
						<label for="old" class="btn btn-outline-secondary">중고도서</label>
						<input type="radio" name="condition" value="EBook" class="btn-check" id="ebook" ${book.condition == 'EBook' ? 'checked' : ''}>
